...
const About = () => {
  return (
    <section
      id="about"
      className="py-4 px-[7vw] md:px-[7vw] lg:px-[18vw] font-sans mt-16 md:mt-20 lg:mt-24"
    >
      <div className="flex flex-col-reverse md:flex-row justify-between items-center">
        ...
        <div className="md:w-1/2 text-center md:text-left mt-8 md:mt-0">
          ...
          {/* Resume Button */}
          <a
            href="https://drive.google.com/file/d/1Yr5GAp2lovirxSb82AHYfhQ_wK6h6I-6/view?usp=drivesdk"
            target="_blank"
        ...
        {/* Right Side */}
        <div className="md:w-1/2 flex justify-center ml-20 md:justify-end">
          <Tilt
